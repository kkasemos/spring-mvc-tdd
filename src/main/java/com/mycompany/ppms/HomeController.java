...
//		logger.info("Welcome Product Search! The client locale is {}.", locale);
//		
//		Date date = new Date();
//		DateFormat dateFormat = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG, locale);
//		
...
//	@RequestMapping(value = "/product/search", method = RequestMethod.GET)
//	public ModelAndView productSearch2(Locale locale, ModelAndView model) throws IOException {
//		logger.info("Welcome Product Search! The client locale is {}.", locale);
//		
//		Date date = new Date();
//		DateFormat dateFormat = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG, locale);
...
//		String formattedDate = dateFormat.format(date);
//		
//		Product product = new Product("bright ppppp");
